...
textbox = instance_create_depth(box_x, box_y, 50, o_jtt_textbox);
...
textbox.next_page();
textbox.set_typing_finished();

var def_val = 1000000/game_get_speed(gamespeed_fps);
delta_vals = array_create(100, def_val);
delta_index = 0;

continue_text = instance_create_depth(box_x, (box_y + textbox.textbox_height), 0, o_jtt_textbox);
continue_text.set_text("<white pulse float:1>Continue...");
continue_text.next_page();
continue_text.set_typing_finished();
